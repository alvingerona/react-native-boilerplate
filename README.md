This boilerplate is improve version of `https://github.com/alvingerona/react-native-boilerplate`
...
The most popular is [mcnamee's Starter Kit](https://github.com/mcnamee/react-native-starter-kit), which is unfortunately [limited by _Expo_](https://facebook.github.io/react-native/docs/getting-started#caveats) and misses Redux Saga.
